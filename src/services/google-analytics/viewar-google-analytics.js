// Adapted by ViewAR for coui protocol. Original version from 16. february 2018.
  ...
  (function() {
    ...
    var oe = function() {
      ...
      wd = function(a, b, c, d) {
        ...
        a = a.replace(/^coui:/, "https:"); // Custom ViewAR
        g.open("POST", a, !0);
        g.withCredentials = !0;
      ...
      ge = function(a, b, c) {
        1 <= 100 * Math.random() ||
          G("?") ||
          ((a = ["t=error", "_e=" + a, "_v=j66", "sr=1"]),
          b && a.push("_f=" + b),
          c && a.push("_m=" + K(c.substring(0, 100))),
          a.push("aip=1"),
          a.push("z=" + hd()),
          wc(oe() + "/collect", a.join("&"), ua));
      };
    var h = function(a) {
    ...
    function Oa() {
      ...
      if ("http:" != a && "https:" != a && "coui:" != a) throw "abort"; // Custom ViewAR
    }
    ...
    var hc = !1,
      ...
      nc = function(a) {
        // if ("cookie" == P(a, ac) && !hc && (mc(a), !hc))throw"abort";    // Custom ViewAR
      },
      Yc = function(a) {
        if (a.get(Wc)) {
          var b = P(a, W),
      ...
      function d(c) {
        try {
          ...
          ("http:" == g.protocol ||
            ...
            sd(a, g.hostname || "") &&
            g.href &&
            (g.href = qd(e, g.href, b)); // Custom ViewAR
        } catch (k) {
          J(26);
        }
      }
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
      ...
      Jc = function(a, b) {
        ...
        a.get(Q) ||
          ((b =
            (b = O.gaGlobal && O.gaGlobal.vid) && -1 != b.search(jd)
              ? b
              : void 0)
            ? (J(17), a.data.set(Q, b))
            : (J(8), a.data.set(Q, ra())));
      ...
      try {
        if (a.u) a.u.call(O, N.j("t0"));
          ...
          if (a.A) {
            ...
            if (a.i) {
              if (
                (a.ha && (a.ha = y(a.c, a.a[0], a.X, a.W)), !u(a.a[0], b, a.W))
              )
                return !0;
            } else if (a.K) {
              var c = a.C,
